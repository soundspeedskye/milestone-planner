  ...
  return (
    <div className="holiday-cards">
      <section className="holiday-card">
        ...
        <div className="modal-hint">공공데이터포털에서 자동으로 받아온 공휴일이에요. 체크를 해제하면 그 날은 영업일로 계산돼요.</div>
      ...
      <section className="holiday-card">
        ...
        <div className="modal-hint">회사 창립일, 전사 휴가 등 공휴일 외 휴무일을 직접 추가하면 일정 계산에서 제외돼요.</div>
